...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['7v7 Event', "For the 7v7 Song,\nValue 1: 0/1 = OFF/ON\n \nYou should only use 0 if you already used 1."],
		['Add Camera Zoom', "Used on MILF on that one \"hard\" part\nValue 1: Camera zoom add (Default: 0.015)\nValue 2: UI zoom add (Default: 0.03)\nLeave the values blank if you want to use Default."],
		['Set Camera Zoom', "Sets the current zooming value of camGame.\nValue 1: Camera zoom value\nValue 2: Duration of the zoom tween\nIf blank, it will tween regularly."],
